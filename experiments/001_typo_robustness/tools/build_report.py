...
const GLOSSARY = {
  ...
  bucket: { t: "Sample-size bucket", d: "design/06 §6.3 decision rule from the implied N: n600_confirmed = the planned N covers this family; raise_n_or_relax_mde = it does not — either raise N or accept a larger minimum detectable effect." },
