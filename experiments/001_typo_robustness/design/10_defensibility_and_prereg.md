...
| 20 | "You haven't shown it matters in the real world." | Tie τ_tok to deployment cost (latency, KV-cache footprint); the mediation result is actionable (motivates input normalization / byte-level models). (Doc 01 §1.9) |
