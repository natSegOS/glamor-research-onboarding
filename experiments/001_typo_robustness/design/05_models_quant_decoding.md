...
- **Recipe caveat in the paper:** we will state plainly that the interaction is characterized for AWQ and GPTQ at 4-bit and is not a universal claim about all quantization (bounded claims; see design/10 §10.1).
